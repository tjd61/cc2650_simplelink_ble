...
\label{dir_b14587e5faa8751b3ef162b7a320070c}\index{ports Directory Reference@{ports Directory Reference}}
Directory dependency graph for ports\+:
\nopagebreak
\begin{figure}[H]
\begin{center}
\leavevmode
\includegraphics[width=211pt]{dir_b14587e5faa8751b3ef162b7a320070c_dep}
\end{center}
\end{figure}
\subsubsection*{Directories}
\begin{DoxyCompactItemize}
\item 
directory \hyperlink{dir_367a8e5795aa1e6ceafecb075b5ac4ea}{tirtos}
