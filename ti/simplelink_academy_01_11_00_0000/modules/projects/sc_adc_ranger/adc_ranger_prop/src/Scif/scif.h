/** \mainpage Driver Overview
  ...
  * Sample ADC input. Let the ADC input determine the measurement period
  * for the Ranger sensor, controlled by the application.
  *
  *
  * \subsection section_io_mapping I/O Mapping
  * Task I/O functions are mapped to the following pins:
  * - ADC:
  *     - <b>A: Analog Sensor Input</b>: DIO27
  * - Ranger:
  *     - <b>XS: Ultrasonic Ranger</b>: DIO29
  *
  *
...
/// ADC I/O mapping: Analog Sensor Input
#define SCIF_ADC_DIO_A_SENSOR_INPUT 27
/// Ranger I/O mapping: Ultrasonic Ranger
#define SCIF_RANGER_DIO_XS_RANGER 29
...
/// Ranger: Task output data structure
typedef struct {
    uint16_t tdcValueH; ///<
    uint16_t tdcValueL; ///<
} SCIF_RANGER_OUTPUT_T;
