...
/* UART Board */
#define Board_UART_RX               IOID_21         /* RXD - Note this is swapped so that boards can be stacked */
#define Board_UART_TX               IOID_22         /* TXD - Note this is swapped so that boards can be stacked */
#define Board_UART_CTS              IOID_19         /* CTS  */
#define Board_UART_RTS              IOID_18         /* RTS */

/* SCIF UART Board*/
#define Board_SCIF_UART_RX          IOID_2          /* SCIF RXD  */
#define Board_SCIF_UART_TX          IOID_3          /* SCIF TXD  */
